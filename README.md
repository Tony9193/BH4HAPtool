...
- 支持 GitHub Releases 检查更新，可在设置页手动检查并在启动时自动提醒
...
- 设置页新增“检查更新”入口，可手动检查 GitHub Releases 最新版本
- 支持启动时自动检查更新
- 发现新版本后可弹窗提示，并直接跳转浏览器下载 APK
...
- 新增 GitHub Releases 检查更新能力，支持设置页手动检查与启动自动提醒
