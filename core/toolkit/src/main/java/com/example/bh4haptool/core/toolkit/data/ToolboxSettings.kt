...
data class ToolboxSettings(
    ...
    val favoriteToolIdsEncoded: String = "",
    val recentToolIdsEncoded: String = "",
    val hiddenToolIdsEncoded: String = "",
    val customToolOrderEncoded: String = "",
    val toolUsageStatsEncoded: String = "",
    val achievementStatesEncoded: String = "",
    val lastUsedToolId: String = "",
    val lastUsedAtMillis: Long = 0L,
    val hostModeKeepScreenOn: Boolean = true,
